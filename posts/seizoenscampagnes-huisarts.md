...
Patienten zijn ontvankelijker voor gezondheidsinformatie als die aansluit bij hun beleving:

- **Voorjaar** → hooikoorts, allergieën → patienten zoeken actief informatie
- **Zomer** → huidbescherming, reisadvies → vakantie op het netvlies
- **Herfst** → griepprik, vitamine D → terugkeer naar routine
- **Winter** → mentale gezondheid, winterdepressie → donkere maanden

Timing is alles bij preventieve communicatie.

## Campagne-kalender voor huisartsen

### Q1 — Januari t/m maart

| Thema | Actie | Doelgroep |
|-------|-------|-----------|
| Goede voornemens | Leefstijladvies, stoppen met roken | Alle patienten |
| Griepnazorg | Evaluatie vaccinatiecampagne | Risicogroepen |
| Winterdepressie | Voorlichting mentale gezondheid | 18-45 jaar |

### Q2 — April t/m juni

| Thema | Actie | Doelgroep |
|-------|-------|-----------|
| Hooikoorts | Tips en medicatie-informatie | Allergiepatienten |
| Tekenbeten | Lyme-preventie voorlichting | Buitensporters |
| Zonnebescherming | Huidkankerpreventie | Alle patienten |

### Q3 — Juli t/m september

| Thema | Actie | Doelgroep |
|-------|-------|-----------|
| Reisvaccinaties | Check vaccinatiestatus | Reizigers |
| Terug-naar-school | Vaccinaties kinderen | Ouders |
| [Preventieve checks](/blog/preventieve-zorg-huisarts) | Jaarlijkse controles | 50-plussers |

### Q4 — Oktober t/m december

| Thema | Actie | Doelgroep |
|-------|-------|-----------|
| Griepprik | Vaccinatiecampagne | Risicogroepen |
| Vitamine D | Suppletie-advies | Alle patienten |
| Eindejaars-check | Bloeddruk, cholesterol | 40-plussers |

## Hoe communiceer je seizoenscampagnes?
...
Houd bij welke campagnes het best werken:

- Hoeveel griepprikken na de herinnering?
- Hoeveel klikken op de nieuwsbrief?
- Hoeveel extra afspraken per campagne?

Na een jaar heb je een datagedreven campagne-kalender die je elk jaar kunt herhalen en verfijnen.
...
[Vraag een gratis scan aan](/gratis-scan) en ontdek hoe seizoenscampagnes jouw praktijk kunnen versterken.

## Conclusie

Seizoenscampagnes zijn de slimste manier om preventie te combineren met patientbinding. Door het juiste bericht op het juiste moment te sturen, ben je relevant zonder opdringerig te zijn. Begin met een eenvoudige kalender van 4 campagnes per jaar en bouw van daaruit verder.
