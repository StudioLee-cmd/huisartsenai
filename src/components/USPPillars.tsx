...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor huisartsen" }, { href: "/chatbot", anchor: "ai chatbot voor huisartsen" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor huisartsen" }, { href: "/reviews", anchor: "review management voor huisartsen" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor huisartsen" }, { href: "/crm", anchor: "crm voor huisartsen" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor huisartsen" }],
    }
];
