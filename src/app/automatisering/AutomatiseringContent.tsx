...
const niche = siteDetails.niche?.toLowerCase() || "huisartsen";
...
const workflows = [
  ...
  },
  {
    ...
    desc: `Klantspecifieke onderhoud- of opvolg-cycli automatisch beheerd. Voor Huisartsen: automatische triage van telefonische verzoeken, herhaalrecept-aanvraag flow, afspraakherinneringen via SMS/WhatsApp — terugkerende omzet zonder dat jij eraan hoeft te denken.`,
  },
];
...
const integrations = [
  { icon: BsWhatsapp, title: "WhatsApp Business", desc: "Het hoofdkanaal — 90% van huisartsen-klanten checkt WhatsApp sneller dan e-mail." },
      ...
      <section className="py-12 md:py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            maar wel volle agendas willen. Jij helpt patiënten, wij regelen de bereikbaarheid.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
