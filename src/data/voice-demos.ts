...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een patiënt belt met klachten; de agent triageert en plant een consult op de juiste urgentie.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand wil het controle-consult verzetten naar later die week.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een patiënt vraagt buiten openingstijd of een herhaalrecept klaarligt.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
